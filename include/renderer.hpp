...
public:
    ...
    /// \param _name identifier for the set of loaded glyphs
    /// \param _path path to the font
    ...
    /// \param _key identifier for the texture
    /// \param _path path to the image
    /// \param _b blendmode for the texture (transparency handling)
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _key identifier for the set
    /// \param _set path to the files
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _key identifier for the texture,
    /// \param _index index of the texture in the vector at '_key'
    /// \param _pos position
    /// \param _orient angle
    /// \param _col colour tint
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _font the font id
    /// \param _pos starting position
    /// \param _ss whether to draw the text in screen-space
    /// \param _mul size multiplier
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _p line start
    /// \param _e line end
    /// \param _scol start colour
    /// \param _ecol end colour
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _d dimensions
    /// \param _col colour
    /// \param _wire draw a rectangle outline, or a filled rectangle
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _identifier texture identifier
    /// \param _index index of the texture at '_identifier'
    /// \param _w reference to be filled with texture width
    /// \param _h reference to be filled with texture height
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// \param _x x coordinate reference
    /// \param _y y coordinate reference
    /// \param _octant octant to convert to
    //----------------------------------------------------------------------------------------------------------------------
