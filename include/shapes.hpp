...
/// @param _start line start, _end line end, _pos circle position, _radius circle radius
//----------------------------------------------------------------------------------------------------------------------
bool lineIntersectCircle(vec2 _start, vec2 _end, vec2 _pos, float _radius);

//----------------------------------------------------------------------------------------------------------------------
/// @brief Returns whether a given point lies on a line.
/// @param _start line start, _end line end, _point point to test
//----------------------------------------------------------------------------------------------------------------------
...
/// @param _start line start, _end line end, _min minimum point of the AABB, _dim dimensions of the AABB
//----------------------------------------------------------------------------------------------------------------------
bool circleIntersectRect(vec2 _pos, float _r, vec2 _min, vec2 _dim);

//----------------------------------------------------------------------------------------------------------------------
/// @brief Returns whether a line intersects a given sphere.
/// @param _start line start, _end line end, _pos sphere position, _radius sphere radius
//----------------------------------------------------------------------------------------------------------------------
