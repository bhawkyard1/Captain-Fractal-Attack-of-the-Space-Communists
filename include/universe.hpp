...
public:
    ...
    /// @param _p position, _v velocity, _tex surface identifier ie "SMOKE".
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// @param _p position, _t team to check against.
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// @param _sel selection menu triggered, _btn button triggered
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// @param _e enemy to add, _s squad to add to.
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// @param _e enemy to remove, _s squad to remove from.
    //----------------------------------------------------------------------------------------------------------------------
    ...
    /// @param _parent parent ship, _child child ship, _offset childs offset from the parent.
    //----------------------------------------------------------------------------------------------------------------------
