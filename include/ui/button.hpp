...
public:
    ...
    //----------------------------------------------------------------------------------------------------------------------
    void update(int _s, const vec2 _mouse, const float _interp);
    ...
    std::string getInitLabel() const {return m_initLabel;}
    ...
    //----------------------------------------------------------------------------------------------------------------------
    void setStart(vec2 _start) {m_start = _start; m_interpolate = true;}
    vec2 getStart() const {return m_start;}

    //----------------------------------------------------------------------------------------------------------------------
    /// \brief Setter for end.
    //----------------------------------------------------------------------------------------------------------------------
    void setEnd(vec2 _end) {m_end = _end; m_interpolate = true;}
