...
{{
     ...
     {{1.0f,	3.0f/DIFFICULTY,    10.0f,       10.0f,		255.0f,	20.0f,	240.0f,	1.0f,   0.8f,   0.002f}},//AI laser 1		4
     {{3.0f,	9.0f/DIFFICULTY,	8.0f,       5.0f,       255.0f,	20.0f,	240.0f,	0.5f,   1.0f,   0.003f}},//AI laser 2		5
     {{1.0f,	2.5f/DIFFICULTY,	4.0f,       15.0f,		255.0f,	20.0f,	240.0f,	0.3f,   0.7f,   0.004f}},//AI laser 3		6
     {{30.0f,	2.0f/DIFFICULTY,	4.0f,       6.0f,       255.0f,	30.0f,	80.0f,	1.0f,   1.0f,   0.008f}},//Boss laser 1	7
     ...
     {{1.0f,	0.5f/DIFFICULTY,	6.0f,       20.0f,		20.0f,	255.0f,	40.0f,	1.0f,   0.9f,   0.03f}},//Turret laser	13
