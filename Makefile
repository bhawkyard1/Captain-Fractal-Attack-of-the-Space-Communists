...
CXXFLAGS      = -pipe -I/usr/local/include/SDL2 -D_REENTRANT -O3 -msse -msse2 -msse3 -march=native -O2 -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
...
obj/observer.o: src/observer.cpp include/observer.hpp \
		include/enemy.hpp \
		include/ship.hpp \
		include/base.hpp \
		include/vectors.hpp \
...
obj/renderer_opengl.o: src/renderer_opengl.cpp include/camera.hpp \
		include/base.hpp \
		include/vectors.hpp \
		include/common.hpp \
		include/renderer_opengl.hpp \
