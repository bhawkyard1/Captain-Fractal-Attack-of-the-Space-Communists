...
# Project:  ed2.pro
# Template: app
# Command: /opt/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-clang -o Makefile ed2.pro
#############################################################################
...
DIST          = resources/menus/buyMenu.txt \
		...
		include/input/inputMap.hpp main.cpp \
		src/aiTarget.cpp \
		src/base.cpp \
		src/camera.cpp \
		src/common.cpp \
...
Makefile: ed2.pro .qmake.cache /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
