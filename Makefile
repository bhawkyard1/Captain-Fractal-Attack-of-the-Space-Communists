...
CXXFLAGS      = -pipe -std=c++11 -msse -msse2 -msse3 -march=native -I/usr/local/include/SDL2 -D_REENTRANT -O2 -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
...
LIBS          = $(SUBLIBS) -L/usr/local/lib -L/home/i7620560/NGL/lib -l NGL -ltiff -Wl,-rpath,/usr/local/lib -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf -L/opt/qt/5.5/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
