#############################################################################
# Makefile for building: Captain\ Fractal-\ Attack\ of\ the\ Space\ Communists
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  ed2.pro
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang -o Makefile ed2.pro
#############################################################################
...
CXXFLAGS      = -pipe -I/usr/local/include/SDL2 -D_REENTRANT -msse -msse2 -msse3 -march=native -O2 -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iinclude -I/home/i7620560/NGL/include -I/opt/qt/5.5/gcc_64/include -I/opt/qt/5.5/gcc_64/include/QtOpenGL -I/opt/qt/5.5/gcc_64/include/QtWidgets -I/opt/qt/5.5/gcc_64/include/QtGui -I/opt/qt/5.5/gcc_64/include/QtCore -Imoc -I/opt/qt/5.5/gcc_64/mkspecs/linux-clang
...
DISTDIR = /home/i7620560/Documents/programming/CA1/projects/Elite-Dangerous-v2.0/obj/Captain\ Fractal-\ Attack\ of\ the\ Space\ Communists1.0.0
LINK          = clang++
...
OBJECTS       = obj/main.o \
		...
		obj/button.o \
		obj/selection.o \
		obj/user_interface.o
DIST          = resources/menus/buyMenu.txt \
		...
		include/ui/user_interface.hpp main.cpp \
		src/base.cpp \
		src/common.cpp \
		src/debris.cpp \
		src/enemy.cpp \
		...
		src/ui/selection.cpp \
		src/ui/user_interface.cpp
QMAKE_TARGET  = Captain\ Fractal-\ Attack\ of\ the\ Space\ Communists
...
Makefile: ed2.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang -o Makefile ed2.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/base.hpp include/common.hpp include/debris.hpp include/enemy.hpp include/faction.hpp include/file.hpp include/inventory.hpp include/laser.hpp include/missile.hpp include/pfx.hpp include/player.hpp include/popup.hpp include/renderer.hpp include/renderer_opengl.hpp include/sfx.hpp include/shapes.hpp include/ship.hpp include/sim_time.hpp include/sprite_sheet.hpp include/sprite_sheet_opengl.hpp include/squad.hpp include/stardust.hpp include/stardust_sprite.hpp include/universe.hpp include/user_input.hpp include/util.hpp include/vectors.hpp include/weapons.hpp include/ui/button.hpp include/ui/selection.hpp include/ui/user_interface.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/base.cpp src/common.cpp src/debris.cpp src/enemy.cpp src/faction.cpp src/file.cpp src/inventory.cpp src/laser.cpp src/missile.cpp src/pfx.cpp src/player.cpp src/popup.cpp src/renderer.cpp src/renderer_opengl.cpp src/sfx.cpp src/shapes.cpp src/ship.cpp src/sim_time.cpp src/sprite_sheet.cpp src/sprite_sheet_opengl.cpp src/squad.cpp src/stardust.cpp src/stardust_sprite.cpp src/universe.cpp src/util.cpp src/vectors.cpp src/ui/button.cpp src/ui/selection.cpp src/ui/user_interface.cpp $(DISTDIR)/
...
obj/main.o: main.cpp include/sim_time.hpp \
		include/vectors.hpp \
		include/util.hpp \
		include/common.hpp \
		include/sfx.hpp \
		...
		/home/i7620560/NGL/include/ngl/Texture.h \
...
obj/popup.o: src/popup.cpp include/popup.hpp \
		include/base.hpp \
		include/vectors.hpp
...
obj/renderer_opengl.o: src/renderer_opengl.cpp include/common.hpp \
		include/vectors.hpp \
		include/renderer_opengl.hpp \
		include/enemy.hpp \
		include/ship.hpp \
...
obj/sprite_sheet_opengl.o: src/sprite_sheet_opengl.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/sprite_sheet_opengl.o src/sprite_sheet_opengl.cpp
...
obj/util.o: src/util.cpp include/common.hpp \
		include/vectors.hpp \
		include/util.hpp
