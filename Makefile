...
CXXFLAGS      = -pipe -std=c++11 -msse -msse2 -msse3 -march=native -I/usr/local/include/SDL2 -D_REENTRANT -g -std=c++11 -Wall -W -Wno-unused-parameter -D_REENTRANT -fPIC $(DEFINES)
