...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Elite\ Dangerous\ v2.01.0.0
DISTDIR = /home/i7620560/Documents/programming/CA1/projects/Elite_Dangerous_v2/obj/Elite\ Dangerous\ v2.01.0.0
LINK          = clang++
...
DIST          = ed2.pro include/base.hpp \
		...
		src/ui/interface.cpp \
		src/ui/selection.cpp
QMAKE_TARGET  = Elite\ Dangerous\ v2.0
