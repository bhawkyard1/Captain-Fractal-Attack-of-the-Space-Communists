        ...
        )
{
    ...
    {
        vec2 lpp = tovec2(_lp->at(i).getPos());
    ...
    {
        vec2 mpp = tovec2(_mp->at(i).getPos());
    ...
    {
        vec2 app = tovec2(_ap->at(i).getPos());
    ...
    for(unsigned int i = 0; i < _ep->size(); i++)
    {
        ...
        col = _fp->at(_ep->at(i).getTeam()).getColour();
        col[3] = 255;
